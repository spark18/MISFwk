...
<script type="text/javascript" src="res/js/tingzi.js"></script>
...
<input type="hidden" name="upload" id="isupload"/>
	...
	<div class="container clearfix page hasRightSidebar">
		<div>
			<div class="title">
				<h4 class="custom-font heading">亭子信息列表</h4>
			</div>
		...
		<div class="page-content">
			...
			<div class="breadcrumb clearfix">
				<a style="outline-style: none;" href="http://wptitans.com/archin"
					...
					href="http://wptitans.com/archin/features/">管理亭子数据信息</a> <span
					class="current">亭子信息导入</span>
			</div>
