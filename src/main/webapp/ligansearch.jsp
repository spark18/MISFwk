...
<script type="text/javascript" src="res/js/ligansearch.js"></script>
	...
	<div class="container clearfix page hasRightSidebar">
		<div>
			<div class="ligan-search-panel">
				<h4 class="custom-font heading">立杆搜索条件</h4>
			</div>
			<div class="ligan-search-result">
				<h4 class="custom-font heading">立杆搜索结果</h4>
			</div>
		</div>
		<div class="clear"></div>
		<div class="page-content">
			...
			<div class="content clearfix">
				...
				<div class="ligan-search-grid">
					<fieldset  class="ligan-search-fieldset">
						<legend>输入立杆设备搜索条件</legend>
						...
						<div class="input" id="number"><label for="line-number">铭牌号</label><input id="line-number" type="text" name="number" class="number"></div>
