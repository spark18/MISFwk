...
<script type="text/javascript" src="res/js/tingzishow.js"></script>
				...
				<div class="simple_overlay" id="mies1">
					...
					<div class="details">
						...
						<div id="fields">
							...
							<p><label for="factory">出厂厂家</label><input type="text" id="factory"></p>
						...
						<div id="fields2">
							...
							<p><label for="equiptype">设备类型</label>
								<select  id="equiptype" name="equiptype">
									<option value="">--</option>
									<option value="三幅亭">三幅亭</option>
									<option value="五幅亭">五幅亭</option>
								</select>
							</p>
							<p>
					...
					<div class="details">
						...
						<div id="old">
							<div id="fields">
								...
								<p><label for="hfactory">厂家</label><input disabled  type="text" id="hfactory"></p>
							...
							<div id="fields2">
								...
								<p><label for="hequiptype">设备类型</label>
									<select disabled  id="hequiptype" name="hequiptype">
										<option value="">--</option>
										<option value="三幅亭">三幅亭</option>
										<option value="五幅亭">五幅亭</option>
									</select>
						...
						<div id="cur">
							...
							<p><label for="factory">厂家</label><input disabled  type="text" id="factory"></p>
						...
						<div id="fields2">
							...
							<p><label for="equiptype">设备类型</label>
								<select disabled  id="equiptype" name="equiptype">
								<option value="">--</option>
								<option value="三幅亭">三幅亭</option>
								<option value="五幅亭">五幅亭</option>
							</select>
