$(document).ready(function(){
	...
	function ligangridify(transactionId) {
		...
		$(".ligan").flexigrid({
			url: 'tingzinhpreview?username=' + $('#username').val() + '&transactionId=' + id,
			dataType: 'json',
			colModel : [
	...
	function liganhistorygridify() {
		$(".ligan-history").flexigrid({
			url: 'tingzinhpreviewtransaction?username=' + $('#username').val(),
			dataType: 'json',
			type: 'POST',
			onSuccess: function() {
	...
	$('#file_upload').uploadify({
	    ...
	    'folder'    : '/uploads',
	    'scriptData': {username: $('#username').val(), type: 'tingzinh'},
	    'method'	: 'get',
