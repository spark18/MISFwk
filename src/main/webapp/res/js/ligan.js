$(document).ready(function(){
	...
	function ligangridify(transactionId) {
		...
		$(".ligan").flexigrid({
			url: 'liganpreview?username=' + $('#username').val() + '&transactionId=' + id,
			dataType: 'json',
			colModel : [
...
//			            					$('#img img').attr('src', 'liganimgshow?entity=LiGanPreview&username=' + $('#username').val() + '&id=' + $('.simple_overlay #rownum').val());
//			            				}
//			            			});
//			            			$('.simple_overlay #submit').click(function() {
//			            				$.ajax({
//			            					url: 'liganpreviewmodify',
//			            					data: {id: $('.simple_overlay #rownum').val(),
//				            					   username: $('#username').val(),
//				            					   line: $('#line').val(),
//				            					   area: $('#area').val(),
...
//			            			    	username: $('#username').val(), entity: "LiGanPreview"},
//			            			    'method'	: 'get',
...
//			            		});
	...
	function liganhistorygridify() {
		$(".ligan-history").flexigrid({
			url: 'liganpreviewtransaction?username=' + $('#username').val(),
			dataType: 'json',
			type: 'POST',
			onSuccess: function() {
	...
	$('#file_upload').uploadify({
	    ...
	    'cancelImg' : 'uploadify/cancel.png',
	    'folder'    : '/uploads',
	    'scriptData': {username: $('#username').val(), type: 'ligan'},
	    'method'	: 'get',
