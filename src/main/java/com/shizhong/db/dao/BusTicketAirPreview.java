...
@Entity
@Table(name = "BUSTICKETAIRPREVIEW")
public class BusTicketAirPreview implements Displayable, IBusTicketPreview {
	private Long id;
	...
	public String toString() {
		return "BusTicketAirPreview [id=" + id + ", type=" + type + ", image="
				+ image + ", pricetype=" + pricetype + ", normPrice="
				+ normPrice + ", airPrice=" + airPrice + ", opunit=" + opunit
