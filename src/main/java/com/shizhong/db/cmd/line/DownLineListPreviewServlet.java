...
public class DownLineListPreviewServlet extends BaseAjaxServlet {
	...
	public void exec(HttpServletRequest req, HttpServletResponse resp)
		...
		downlineList.setPage(String.valueOf(page));
		...
		for (Object pageResult : pageResults) {
			...
			DownLinePreview liGan = (DownLinePreview) pageResult;
