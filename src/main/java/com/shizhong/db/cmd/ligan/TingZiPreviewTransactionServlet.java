...
public class TingZiPreviewTransactionServlet extends BaseAjaxServlet {
	...
	public void exec(HttpServletRequest req, HttpServletResponse resp)
		...
		Query query = session
				.createQuery("from PreTransaction transaction where transaction.user.name='"
						...
						+ PreTransaction.Type.TINGZIPREVIEWLOAD.name() + "' order by transaction.timeStamp DESC");
		...
		for (Object tingziTransactionResult : tingziTransactionList) {
			...
			PreTransaction szTransaction = (PreTransaction) tingziTransactionResult;
